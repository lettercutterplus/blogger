...
var postFilter = "";
var numberfeed = 0;
var ajax = '<div class="ajax_loading" style="text-align: center; width:50px;height: 50px;margin: 50px auto;"><img src="https://raw.githubusercontent.com/lettercutterplus/blogger/master/ajax-loader.gif" style="width: 100%;height: 100%; box-shadow: none; border: 0px; padding: 0px;"></div>';
...
function hideToc() {
	...
	b.innerHTML = '<a href="#" onclick="scroll(0,0); showToc(); Effect.toggle(\'toc-result\',\'blind\');">?? Menampilkan Daftar Isi</a> <img src="https://raw.githubusercontent.com/lettercutterplus/blogger/master/new.gif"/>'
}
